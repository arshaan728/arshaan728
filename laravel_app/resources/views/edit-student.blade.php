...
<form method="POST" action="{{url('update-user')}}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="contact" name='contact'  placeholder="Enter contact" value="{{$data->contact}}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="password" name='password'  placeholder="Enter password" value="{{$data->password}}">
